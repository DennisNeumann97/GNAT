...
def produce_results_for_input_data(
    ...
    if outpath is not None:
        ...
        plt.savefig(f'{outpath}/triangle_plot.png')
        plt.close()
...
def plot_best_fit_vs_data(
    ...
    if which_measurement == 'projections':
        ...
        ax_xlabel = r'$r$ [Mpc]'
        ax0_ylabel = r'$r \xi_\mathrm{gg}$ [Mpc$^2$]'
        ax1_ylabel = r'$r \xi_\mathrm{g+}$ [Mpc$^2$]'
    ...
    for sim in measurement_dict.keys():
        ...
        for snapshot in measurement_dict[sim].keys():
            ...
            if will_analyse:
                ...
                try:
                    rp_gg_data = measurement_dict[sim][snapshot]['w_gg'][data_str + '_rp']/cosmo_dict[sim]['h']
                    w_gg_data = measurement_dict[sim][snapshot]['w_gg'][data_str]/cosmo_dict[sim]['h']
                    w_gg_cov_data = measurement_dict[sim][snapshot]['w_gg'][data_str + '_cov']/cosmo_dict[sim]['h']**2

                    rp_gplus_data = measurement_dict[sim][snapshot]['w_g_plus'][data_str + '_rp']/cosmo_dict[sim]['h']
                    w_gplus_data = measurement_dict[sim][snapshot]['w_g_plus'][data_str]/cosmo_dict[sim]['h']
                    w_gplus_cov_data = measurement_dict[sim][snapshot]['w_g_plus'][data_str + '_cov']/cosmo_dict[sim]['h']**2

                    r_gg_data = measurement_dict[sim][snapshot]['multipoles_gg'][data_str + '_r']/cosmo_dict[sim]['h']
                    xi_gg_data = measurement_dict[sim][snapshot]['multipoles_gg'][data_str]
                    xi_gg_cov_data = measurement_dict[sim][snapshot]['multipoles_gg'][data_str + '_cov']

                    r_gplus_data = measurement_dict[sim][snapshot]['multipoles_g_plus'][data_str + '_r']/cosmo_dict[sim]['h']
                    xi_gplus_data = measurement_dict[sim][snapshot]['multipoles_g_plus'][data_str]
                    xi_gplus_cov_data = measurement_dict[sim][snapshot]['multipoles_g_plus'][data_str + '_cov']
                ...
                outpath_projections = f'/home/dneup16/leiden_phd/scripts/results/IA_redshift_dependency_simulations/fit_results_projections_{sim}/fit_results_{snapshot}/'
                outpath_multipoles = f'/home/dneup16/leiden_phd/scripts/results/IA_redshift_dependency_simulations/fit_results_multipoles_{sim}/fit_results_{snapshot}/'
                ...
                plot_best_fit_vs_data(
                    ...
                    fitting_range=fitting_range,
                    outpath=f'{outpath_projections}/best_fit_vs_data.png',
                    r_scaling_for_plot=1,
                    which_measurement='projections',
                )
                logger.info('...done')
                ...
                plot_best_fit_vs_data(
                    ...
                    fitting_range=fitting_range,
                    outpath=f'{outpath_multipoles}/best_fit_vs_data.png',
